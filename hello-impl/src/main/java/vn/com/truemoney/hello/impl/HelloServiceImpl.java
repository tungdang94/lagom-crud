...
import vn.com.truemoney.hello.api.GreetingMessage;
import vn.com.truemoney.hello.api.HelloService;
import vn.com.truemoney.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<vn.com.truemoney.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      vn.com.truemoney.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new vn.com.truemoney.hello.api.HelloEvent.GreetingMessageChanged(
